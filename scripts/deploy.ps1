...
try {
    ...
    # Shipped data (collectibles/, locations/) is embedded in the DLL and
    # written out by the plugin on startup - see src/Data/ShippedData.cs.
    # Nothing to sync here; a drop-in install behaves exactly like this one.
}
finally {
    Pop-Location
}
